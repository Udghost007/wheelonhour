...
export const metadata: Metadata = {
  title: "Maruti Suzuki Dzire on Rent in Ahmedabad | ₹2,600/Day — wheelsonhours",
  description:
    "Rent Maruti Suzuki Dzire in Ahmedabad at ₹2,600/day. Compact sedan, self-drive, fully insured, easy pickup from Devnagar Gam Road. Book on WhatsApp — wheelsonhours.",
  keywords: [
